// components/deposit/GasFeeSection.tsx
...
import GasModeSelectorPopup from "../components/GasModeSelectorPopupWithdraw";
...
const GasFeeSection = () => {
    ...
    let {
        ...
        static_gas: {
            ...
            estimates: {
                withdraw: fallbackWithdrawFeeUsd = 0,
                optimizedWithdraw: fallbackOptimizedFeeUsd = 0,
                withdrawEth: fallbackWithdrawFeeEth = 0,
                optimizedWithdrawEth: fallbackOptimizedFeeEth = 0,
            } = {},
        } = {},
    } = walletInfo ?? {};
    ...
    const displayFeeUsd = optimized
        ? finalOptimizedFeeUsd
        : finalWithdrawFeeUsd;
    const displayFeeEth = optimized
        ? finalOptimizedFeeEth
        : finalWithdrawFeeEth;
